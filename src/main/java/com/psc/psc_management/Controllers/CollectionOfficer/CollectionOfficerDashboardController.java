...
public class CollectionOfficerDashboardController {
    ...
    public String saveBuyPaddy(BuyPaddy buyPaddy , RedirectAttributes message, @AuthenticationPrincipal MyUserDetails employee) {
        ...
        if (buyPaddy.getQuantity()>branch.getCropLimit()){
            message.addFlashAttribute("error", "Error : The Quantity is greater than the crop limit of the branch set for each farmer");
            ...
            float leftBudget = branch.getBudget() - branch.getUsedBudget();
